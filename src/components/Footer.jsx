  ...
  return (
    <div className="md:grid grid-cols-4 p-5 md:p-0">
      <div data-aos="fade-right" >
        <h1 className="text-xl font-light mb-3">WORKSTATION</h1>
        <p className="mb-1">Hooghly</p>
        <p className="mb-5">West Bengal, India</p>

        <div>
          <p className="font-medium">
            Phone: <span className="font-normal ml-1">+91 90625 47010</span>
          </p>
          <p className="font-medium">
            Email: <span className="font-normal ml-1">workstationexperts@gmail.com</span>
          </p>
        </div>
      </div>
